...
# Initialise empty config as a dict to be written to
config = {}
...
try:
	# This will fail if the consumer key/secret is invalid.
...
try:
	# Returned is a tuple with format [token, secret].
